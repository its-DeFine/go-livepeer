...
func NewLivepeerConfig(fs *flag.FlagSet) LivepeerConfig {
	...
	fs.StringVar(cfg.ExternalSignerURL, "externalSignerUrl", *cfg.ExternalSignerURL, "Loopback HTTP endpoint for the external account manager")
	fs.StringVar(cfg.ExternalSignerChainID, "externalSignerChainId", *cfg.ExternalSignerChainID, "Chain ID asserted to the external account manager")
	fs.StringVar(cfg.ExternalSignerTokenFile, "externalSignerTokenFile", *cfg.ExternalSignerTokenFile, "0600 file containing the external account manager bearer token")
